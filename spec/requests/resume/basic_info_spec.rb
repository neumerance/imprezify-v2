...
feature 'Resume Edit Form', :js do
  ...
  scenario 'filling up basic info fields' do
    within('#basic-info') do
      ...
      fill_in 'resume[basic_info_attributes][address]', with: FFaker::AddressUS.street_address
      ...
      fill_in 'resume[basic_info_attributes][postal_code]', with: FFaker::AddressUS.zip_code
